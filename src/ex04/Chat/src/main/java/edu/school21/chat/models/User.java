...
public class User {
    ...
    public void addCreatedRooms(Room createdRooms) {
        if (createdRooms != null) {
            this.createdRooms.add(createdRooms);
        }
    }
    ...
    public void addSocializedRooms(Room socializedRooms) {
        if (socializedRooms != null) {
            this.rooms.add(socializedRooms);
        }
    }
